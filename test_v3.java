...
public class test_v3 {
    ...
    // try-with-resources was used kasi ano, for automatic resource management (no leak resources and no need for manual closing)
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (continueRiding) {
                ...
                while (true) {
                    ...
                    int fare = fareMatrix[cardType.equalsIgnoreCase("Beep") ? 0 : 0][currentStation
                            + 1][destinationStation - 1];
    ...
    // NOT FUCKING USED AT ALL, KEEPING IT FOR REFERENCE AND JUST IN CASE (IYKYK)
