...
public class test_v1_1 {
            ...
            while (continueRiding) {
                ...
                while (!validInput) {
                    ...
                    while (true) {
                        ...
                        displayCurrent(fare, totalFare, totalDistance, destinationStation, currentStation, cardType,
                                card);
    ...
    private static void displayCurrent(int fare, int totalFare, float totalDistance, int destinationStation,
